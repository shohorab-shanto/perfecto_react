        ...
        axios
            ...
            .then((res) => {
                if (res.data.status === true) {
                    ...
                    setIsResponseLoading(false);
                    const emailError = res?.data?.data?.email;
                    const phoneError = res?.data?.data?.phone;
                    if (emailError) {
        ...
        <div className="mx-2">
            ...
            >
                ...
                <div className="pt-2 px-2 pb-2 xs:px-5 md:pt-3 md:px-7 md:pb-5 lg:pt-6 lg:px-[60px] lg:pb-[40px]">
                    <h3 className="mb-3 lg:mb-6 text-black font-inter font-medium text-2xl lg:text-4xl leading-normal">Register</h3>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div>
                            <div className="mb-5">
                                ...
                                <input
                                    {...register("f_name", {
                                        required: true, // Regular expression for 11 digits starting with 0
                                    })}
                                ...
                                />
                                {errors.f_name && errors.f_name.type === "required" && <span className="text-red-600">This field is required</span>}
                            </div>
                            <div className="mb-5">
                                <label>
                                    <span className="flex text-sm font-medium mb-3">
                                ...
                                <input
                                    ...
                                    className="p-2 w-full rounded-sm text-[14px] bg-white border-[0.5px] border-[#bfbfbf]"
                                />
                                {errors.l_name && errors.l_name.type === "required" && <span className="text-red-600">This field is required</span>}
                            </div>
                            <div className="mb-5">
                                <label>
                                    <span className="flex text-sm font-medium mb-3">
