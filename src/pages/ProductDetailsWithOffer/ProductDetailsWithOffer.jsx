...
import "./ProductDetailsWithOffer.scss";
              ...
              /> */}
                        ...
                        <span className="text-[#02792A] font-semibold text-base">
                          (-25% Off)
                                    ...
                                    {/* offer area start */}
                                    <div className="bg-[#EDEFF0] py-3 ps-2 md:ps-4 mb-3 md:mb-7">
                                        <ul className=" ps-4">
                                            <li className="list-disc text-[#000000CC] font-Inter text-xs xs:text-sm font-normal leading-normal">
                                                Free Highlighter Palette worth Rs 749 on Rs 999
                                            </li>
                                            {isReviewMoreOffer && (
                                                <li className="list-disc text-[#000000CC] font-Inter text-xs xs:text-sm font-normal leading-normal">
                                                    Pick a Free Gift on Orders above Rs 2000/-
                                                </li>
                                            )}
                                            {isReviewMoreOffer ? (
                                                <li
                                            ...
                                            <div className="flex items-center justify-between mb-1">
                                                <div className="relative">
                                                    <div
                                                        ...
                                                        className="flex items-center gap-1 sm:gap-4 hover:cursor-pointer"
                                                    >
                              ...
                              <FaAngleDown/>
                                                    ...
                                                    <div
                                                        style={{boxShadow: "0px 0px 6px 0px #E4EDF0"}}
                                                        className={`absolute top-6 w-52  whitespace-nowrap bg-white rounded overflow-hidden z-20 ${
...
export default ProductDetailsWithOffer;
